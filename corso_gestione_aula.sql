...
--
-- Host: 127.0.0.1
-- Creato il: Gen 12, 2026 alle 11:39
...
--
CREATE DATABASE IF NOT EXISTS `corso_gestione_aula` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `corsisti` (
  ...
  `amico` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`amico`))
...
INSERT INTO `corsisti` (`id`, `nome`, `cognome`, `codice_fiscale`, `data_di_nascita`, `email`, `telefono`, `indirizzo_residenza`, `localita_residenza`, `provincia_residenza`, `cap_residenza`, `genere`, `amico`) VALUES
